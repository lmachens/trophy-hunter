...
const SkillsIcon: FC<Props> = ({ disabled = false, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M11.7631 28.5638L6.43301 27.7959L6.75 26.2469L11.2141 26.5148L20.4952 17.4395L31.1284 15.0039L42.5657 19.2123L49.976 26.3773L52.891 26.3283L53.007 28.1273L49.409 28.3594L41.5657 20.9443L31.1284 17.0039L21.0442 19.4885L11.7631 28.5638Z"
        fill="#525058"
      />
      <rect
        x="30.3857"
