...
export { default as giantsBelt } from './giantsBelt';
export { default as gloriousEvolution } from './gloriousEvolution';
...
export { default as theWanderer } from './theWanderer';
...
export { default as trophyHunterKing } from './trophyHunterKing';
