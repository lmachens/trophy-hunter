...
export { default as privateFirstClass } from './privateFirstClass';
export { default as privateSecondClass } from './privateSecondClass';
export { default as prominent } from './prominent';
export { default as sergeant } from './sergeant';
