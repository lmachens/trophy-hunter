...
const HubIsland: FC<IslandProps> = ({ open, closed, done, ...svgProps }) => {
  return (
    <>
      <svg
        width="187"
      ...
      >
        ...
        {done && (
          <circle
            r="3.25"
            transform="matrix(-1 -2.14998e-08 -2.22175e-08 1 94.0001 62)"
            fill="#EAEAEA"
            stroke="#EAEAEA"
            strokeWidth="1.5"
          />
        ...
        {(closed || open) && (
          <>
            ...
            <circle
              r="3.25"
              transform="matrix(-1 -2.18557e-08 -2.18557e-08 1 94.0001 62)"
              stroke="#EAEAEA"
              strokeWidth="1.5"
            />
          </>
        ...
        <CombatLevel transform="translate(48 30)" active />
        <SkillsLevel transform="translate(89 13)" unlocked />
        <TeamplayLevel transform="translate(132 30)" locked />
        <ObjectivesLevel transform="translate(132 90)" active />
        <EpicLevel transform="translate(89 105)" completed />
        <SpecialLevel transform="translate(48 90)" completed />
      </svg>
    </>
  );
};
