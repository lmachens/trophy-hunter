...
const HubIsland: FC<IslandProps> = ({ open, done, ...svgProps }) => {
  return (
    <svg
      width="187"
      height="184"
    ...
    >
      ...
      <circle
        opacity={open ? '1' : '0.4'}
        r="3.25"
        transform="matrix(-4.37114e-08 1 1 4.37114e-08 48 30)"
        stroke="#FF9330"
        strokeWidth="1.5"
      />
      ...
      <circle
        opacity={open ? '1' : '0.4'}
        r="3.25"
        transform="matrix(-1 -2.18557e-08 -2.18557e-08 1 95 13)"
        stroke="#FBFF2E"
        strokeWidth="1.5"
        fill={done ? '#FBFF2E' : ''}
      />
      <circle
        opacity={open ? '1' : '0.4'}
        r="3.25"
        transform="matrix(-1 -2.18557e-08 -2.18557e-08 1 95 110)"
        stroke="#C956FF"
        strokeWidth="1.5"
      />
      <circle
        opacity={open ? '1' : '0.4'}
        r="3.25"
        transform="matrix(-1 8.74228e-08 8.74228e-08 1 48 93)"
        stroke="url(#playground)"
        strokeWidth="1.5"
      />
